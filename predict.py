...
def predict(
    ...
    for fold_idx in range(config["n_folds"]):
        ...
        model_path = model.load_checkpoint('best_model', os.path.join(model_dir, f'{fold_idx}'))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="./out_sleepedf/predict")
    parser.add_argument("--log_file", type=str, default="./out_sleepedf/predict.log")
